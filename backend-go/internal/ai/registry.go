...
func DefaultRegistry() *AgentRegistry {
	agents := []AgentSpec{
		...
		{ID: "A8", Name: "Feedback Triage Agent", Squad: "governance", Autonomy: "supervised",
			DecisionPoints: []string{"feedback_triage"},
			Description:    "反馈审阅：用户反馈分类、优先级打分、决定是否采纳", ModelHint: "gpt-4o-mini", RiskFloor: "medium"},
