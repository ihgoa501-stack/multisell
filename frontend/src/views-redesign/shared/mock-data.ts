...
export const mockMenuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'categories', label: '分类管理', icon: 'AppstoreOutlined', path: '/categories' },
      { key: 'inventory', label: '库存管理', icon: 'DatabaseOutlined', path: '/products/u-001/inventory' },
      { key: 'brands', label: '品牌管理', icon: 'TagOutlined', path: '/brands' },
    ],
  },
  {
    key: 'supply',
    label: '供应链',
    items: [
      { key: 'suppliers', label: '供应商', icon: 'TeamOutlined', path: '/suppliers' },
      { key: 'sourcing', label: '1688 选品', icon: 'CloudDownloadOutlined', path: '/1688-sourcing' },
      { key: 'shipping', label: '物流管理', icon: 'TruckOutlined', path: '/shipping/manage' },
    ],
  },
  {
    key: 'trade',
    label: '交易平台',
    items: [
      { key: 'platforms', label: '平台管理', icon: 'GlobalOutlined', path: '/platforms' },
      { key: 'listings', label: '上架管理', icon: 'UploadOutlined', path: '/listings' },
      { key: 'orders', label: '订单管理', icon: 'ShoppingCartOutlined', path: '/orders' },
      { key: 'settlements', label: '结算中心', icon: 'AccountBookOutlined', path: '/settlements' },
      { key: 'finance', label: '财务管理', icon: 'MoneyCollectOutlined', path: '/finance' },
    ],
  },
  {
    key: 'system',
    label: '系统',
    items: [
      { key: 'notifications', label: '通知中心', icon: 'BellOutlined', path: '/notifications', badge: 5 },
      { key: 'users', label: '用户管理', icon: 'UserOutlined', path: '/users' },
      { key: 'agents', label: 'Agent 管理', icon: 'ExperimentOutlined', path: '/agents' },
      { key: 'reports', label: '数据报表', icon: 'BarChartOutlined', path: '/reports' },
    ],
  },
]
