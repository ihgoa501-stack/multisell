...
import { listOrderImports, getOrderImport, listOrderImportItems, importOrders } from '@/api/modules/orderImport'
...
const batchColumns: DataTableColumns<any> = [
  ...
  { title: '导入时间', key: 'created_at', width: 180 },
  {
    ...
    width: 120,
    render: (row: any) =>
      h('n-button', { size: 'small', onClick: () => openBatch(row) }, { default: () => '查看明细' }),
  },
]
