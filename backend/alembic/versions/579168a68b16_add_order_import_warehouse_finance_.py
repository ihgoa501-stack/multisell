...
def upgrade() -> None:
    # ── order_import 订单导入记录 ──────────────────────────────
    op.create_table('order_import',
        sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column('platform_id', sa.BigInteger(), nullable=True, comment='平台ID'),
        sa.Column('source_type', sa.String(length=50), nullable=False, comment='来源: ozon/shopee/wb/manual'),
    ...
    op.create_table('warehouse',
        ...
        sa.Column('is_default', sa.SmallInteger(), nullable=True, comment='是否默认仓库'),
    ...
    op.create_table('allocation_rule',
        sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column('name', sa.String(length=200), nullable=False, comment='规则名称'),
        sa.Column('priority', sa.Integer(), nullable=True, comment='优先级'),
        sa.Column('rule_type', sa.String(length=50), nullable=False, comment='规则类型: percentage/fixed/priority'),
        sa.Column('warehouse_id', sa.BigInteger(), nullable=False, comment='仓库ID'),
        sa.Column('allocation_pct', sa.Numeric(precision=5, scale=2), nullable=True, comment='分配百分比'),
        sa.Column('allocation_qty', sa.Integer(), nullable=True, comment='固定分配数量'),
        sa.Column('status', sa.SmallInteger(), nullable=True, comment='状态: 0-禁用, 1-启用'),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True, comment='创建时间'),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True, comment='更新时间'),
    ...
    op.create_table('finance_account',
        ...
        sa.Column('account_type', sa.String(length=50), nullable=False, comment='账户类型: platform/payment/bank/cash'),
        ...
        sa.Column('balance', sa.Numeric(precision=14, scale=2), nullable=True, comment='余额'),
        sa.Column('status', sa.SmallInteger(), nullable=True, comment='状态: 0-禁用, 1-启用'),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True, comment='创建时间'),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True, comment='更新时间'),
        sa.ForeignKeyConstraint(['platform_id'], ['platform.id'], ),
    ...
    op.create_table('finance_transaction',
        ...
        sa.Column('transaction_type', sa.String(length=50), nullable=False, comment='类型: revenue/cost/fee/refund/transfer'),
        sa.Column('amount', sa.Numeric(precision=14, scale=2), nullable=False, comment='金额（正收入/负支出）'),
        sa.Column('currency', sa.String(length=3), nullable=True, comment='币种'),
        sa.Column('order_id', sa.BigInteger(), nullable=True, comment='关联订单ID'),
        sa.Column('settlement_id', sa.BigInteger(), nullable=True, comment='关联结算单ID'),
        sa.Column('platform_id', sa.BigInteger(), nullable=True, comment='关联平台ID'),
        sa.Column('description', sa.String(length=500), nullable=True, comment='描述'),
        sa.Column('transaction_date', sa.DateTime(timezone=True), nullable=True, comment='交易日期'),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True, comment='创建时间'),
        sa.ForeignKeyConstraint(['account_id'], ['finance_account.id'], ),
