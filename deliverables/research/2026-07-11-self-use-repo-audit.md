...
> **历史审计，不是当前经营指令。** 本文按首轮 Ozon 实验评估仓库复用能力，其中的 Ozon 优先级已经失效；代码能力仍可作技术参考。执行口径以 `docs/SELF_USE_OPERATING_DIRECTION.md` 为准。
...
- `docs/SELF_USE_OPERATING_DIRECTION.md`、`docs/CURRENT_DIRECTION_AND_PRIORITIES.md`、`docs/ops/OWNER_AND_AI_DEPLOYMENT_RUNBOOK.md`：统一成不预设国家、平台或固定数量的 Owner 自用经营闭环。
