...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("source_filename", sa.String(500), nullable=False, comment="源文件名"),
        sa.Column("row_count", sa.Integer(), server_default="0", comment="导入行数"),
        sa.Column("created_order_count", sa.Integer(), server_default="0", comment="创建订单数"),
        sa.Column("skipped_duplicate_count", sa.Integer(), server_default="0", comment="跳过重复数"),
    ...
    op.create_table(
        "order_import_item",
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
        sa.Column("batch_id", sa.BigInteger(), sa.ForeignKey("order_import_batch.id"), nullable=False, comment="批次ID"),
        ...
        sa.Column("order_id", sa.BigInteger(), sa.ForeignKey("sales_order.id"), comment="系统订单ID"),
        ...
        sa.Column("status", sa.String(50), nullable=False, comment="imported/created_order/skipped_duplicate/failed"),
