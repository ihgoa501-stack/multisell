...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(20),
            nullable=False,
            comment="Agent标识: A3/A4/A5/A6/A7/G1/G2/G3",
        ),
        ...
        sa.Column(
            "final_decision", sa.JSON(), nullable=False, comment="最终执行的决策"
        ),
        sa.Column(
            "user_action",
            sa.String(20),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(20),
            nullable=False,
            comment="规则类型: threshold/strategy/style/veto",
        ),
        ...
        sa.Column(
            ...
            sa.String(20),
            nullable=False,
            comment="来源: manual/nudge/auto_extracted/template",
        ),
        ...
        sa.Column(
            ...
            sa.String(20),
            default="active",
            comment="状态: active/shadow/paused/retired",
        ),
        ...
        sa.Column(
            "last_applied_at", sa.DateTime(timezone=True), comment="最后应用时间"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column("agent_id", sa.String(20), nullable=False, comment="Agent标识"),
        sa.Column(
            "episode_number", sa.Integer(), nullable=False, comment="Episode序号"
        ),
        ...
        sa.Column(
            "ended_at", sa.DateTime(timezone=True), nullable=False, comment="结束时间"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "risk_tolerance", sa.String(30), default="moderate", comment="风险容忍度"
        ),
        sa.Column(
            "communication_style", sa.String(20), default="balanced", comment="沟通风格"
        ),
        sa.Column("notification_prefs", sa.JSON(), comment="通知偏好"),
        sa.Column(
            "agent_profiles", sa.JSON(), nullable=False, comment="各Agent配置档案"
        ),
        sa.Column("hypothesis_count", sa.Integer(), default=0, comment="假设数量"),
        sa.Column("confirmed_count", sa.Integer(), default=0, comment="已验证数量"),
        sa.Column(
            "last_dialectic_at", sa.DateTime(timezone=True), comment="上次辩证对话时间"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "decision_id",
            sa.BigInteger(),
            sa.ForeignKey("agent_decision.id"),
            nullable=False,
            comment="决策ID",
        ),
        sa.Column(
            "conflicting_rules", sa.JSON(), nullable=False, comment="冲突规则ID列表"
        ),
        sa.Column(
            "winner_rule_id", sa.BigInteger(), nullable=False, comment="胜出规则ID"
        ),
