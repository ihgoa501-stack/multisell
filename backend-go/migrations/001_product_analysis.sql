-- Migration: create product_analysis and analysis_feedback tables
-- Version: 001
-- Apply: psql -d multisell -f migrations/001_product_analysis.sql
...
CREATE INDEX idx_product_analysis_sourcing_product ON product_analysis(sourcing_product_id);
CREATE INDEX idx_product_analysis_analyzed_by ON product_analysis(analyzed_by);
...
CREATE INDEX idx_analysis_feedback_analysis ON analysis_feedback(product_analysis_id);
