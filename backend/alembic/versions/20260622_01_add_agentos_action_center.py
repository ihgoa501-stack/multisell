...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "risk_level", sa.String(length=20), nullable=False, server_default="medium"
        ),
        sa.Column(
            "requires_approval",
            sa.Boolean(),
        ...
        sa.Column(
            "status", sa.String(length=30), nullable=False, server_default="suggested"
        ),
    ...
    op.create_index(
        "ix_agentos_action_proposal_source_type",
        "agentos_action_proposal",
        ["source_type"],
    )
    op.create_index(
        "ix_agentos_action_proposal_source_id", "agentos_action_proposal", ["source_id"]
    )
    op.create_index(
        "ix_agentos_action_proposal_agent_id", "agentos_action_proposal", ["agent_id"]
    )
    op.create_index(
        "ix_agentos_action_proposal_squad_id", "agentos_action_proposal", ["squad_id"]
    )
    op.create_index(
        "ix_agentos_action_proposal_action_type",
        "agentos_action_proposal",
        ["action_type"],
    )
    op.create_index(
        "ix_agentos_action_proposal_business_object_type",
        "agentos_action_proposal",
        ["business_object_type"],
    )
    op.create_index(
        "ix_agentos_action_proposal_business_object_id",
        "agentos_action_proposal",
        ["business_object_id"],
    )
    op.create_index(
        "ix_agentos_action_proposal_risk_level",
        "agentos_action_proposal",
        ["risk_level"],
    )
    op.create_index(
        "ix_agentos_action_proposal_status", "agentos_action_proposal", ["status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "decision", sa.String(length=30), nullable=False, server_default="pending"
        ),
    ...
    op.create_index(
        "ix_agentos_approval_request_proposal_id",
        "agentos_approval_request",
        ["proposal_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=30), nullable=False, server_default="started"
        ),
        sa.Column(
            "input_payload",
            json_type,
    ...
    op.create_index(
        "ix_agentos_command_execution_proposal_id",
        "agentos_command_execution",
        ["proposal_id"],
    )
    ...
    op.create_index(
        "ix_agentos_outcome_review_proposal_id",
        "agentos_outcome_review",
        ["proposal_id"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_agentos_outcome_review_proposal_id", table_name="agentos_outcome_review"
    )
    op.drop_table("agentos_outcome_review")
    op.drop_index(
        "ix_agentos_command_execution_proposal_id",
        table_name="agentos_command_execution",
    )
    op.drop_table("agentos_command_execution")
    op.drop_index(
        "ix_agentos_approval_request_proposal_id", table_name="agentos_approval_request"
    )
    op.drop_table("agentos_approval_request")
    op.drop_index(
        "ix_agentos_action_proposal_status", table_name="agentos_action_proposal"
    )
    op.drop_index(
        "ix_agentos_action_proposal_risk_level", table_name="agentos_action_proposal"
    )
    op.drop_index(
        "ix_agentos_action_proposal_business_object_id",
        table_name="agentos_action_proposal",
    )
    op.drop_index(
        "ix_agentos_action_proposal_business_object_type",
        table_name="agentos_action_proposal",
    ...
    op.drop_index(
        "ix_agentos_action_proposal_action_type", table_name="agentos_action_proposal"
    )
    op.drop_index(
        "ix_agentos_action_proposal_squad_id", table_name="agentos_action_proposal"
    )
    op.drop_index(
        "ix_agentos_action_proposal_agent_id", table_name="agentos_action_proposal"
    )
    op.drop_index(
        "ix_agentos_action_proposal_source_id", table_name="agentos_action_proposal"
    )
    op.drop_index(
        "ix_agentos_action_proposal_source_type", table_name="agentos_action_proposal"
    )
